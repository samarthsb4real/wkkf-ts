...
export default function Navbar2() {
  ...
  return (
    <Navbar onMenuOpenChange={setIsMenuOpen} className="bg-gray-900 fixed top-0 left-0 z-50">
      <NavbarContent className="navbar bg-gray-900 fixed top-0 left-0 p-2 z-50">
        <NavbarMenuToggle

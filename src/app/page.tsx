...
const HomePage = () => {
  ...
  return (
    <div className="no-visible-scrollbar">
      ...
      <div className="no-visible-scrollbar m-12 rounded-2xl h-full p-4 overflow-hidden bg-black border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20">
